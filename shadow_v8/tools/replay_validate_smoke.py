...
def main() -> None:
    ...
    assert_true("top_stage_block_reason" in row, "Replay validation summary should include top stage block reason")
    assert_true("top_stage_block_detail" in row, "Replay validation summary should include top stage block detail")
    ...
    print(f"top_stage_block_reason={row['top_stage_block_reason']}")
    print(f"top_stage_block_detail={row['top_stage_block_detail']}")
